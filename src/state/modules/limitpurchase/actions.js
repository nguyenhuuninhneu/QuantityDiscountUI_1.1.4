...
export const saveBulkActionPurchaseCompleted = (data) => {
  return {
    type: types.SAVE_BULKACTIONPURCHASECOMPLETED,
    payload: data,
  };
};


export const saveBulkActionPurchaseFailed = (data) => {
  return {
    type: types.SAVE_BULKACTIONPURCHASEFAILED,
    payload: data,
  };
};