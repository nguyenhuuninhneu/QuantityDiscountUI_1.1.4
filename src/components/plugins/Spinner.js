...
export default class SpinnerAbsolute extends React.Component {
    render() {
        return (
            <>
                <div className='spinner-bound'>
                    <div className="spinner-absolute">
                        <div p-color-scheme="light"><span class="Polaris-Spinner Polaris-Spinner--sizeLarge"><svg viewBox="0 0 44 44" xmlns="http://www.w3.org/2000/svg">
